...
import { createTask, deleteTask, editTask, getGroupTaskById, getGroupTasks } from "./task-controller.js";
...
router.delete("/:groupId/:taskId", auth, deleteTask, errorHandler); //group is there to verify that the user can access the info
